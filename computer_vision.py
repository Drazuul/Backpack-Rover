...
while True:
    ...
    img = sensor.snapshot().binary([(48, 255)])  # Take a picture and return the image.
    ...
    usb.send(struct.pack("<i", int(deflection_angle)))
    #print(struct.pack("<i", int(deflection_angle)), int(deflection_angle))
    #usb.send(int(deflection_angle))
